...
let livesPara = document.getElementById('lives');
let highScoreSpan = document.getElementById('highscore');
let continueText = document.getElementById('continue');
...
//game sounds
const startTheme = new Audio('./audio/start.wav');
const eatDotSound = new Audio('./audio/eat_dot_1.wav');
const deathSound = new Audio('./audio/death_0.wav');
...
window.onload = () => {
    ...
    if (localStorage.getItem("highScore") !== null) {
        highScoreSpan.textContent = `Highscore: ${localStorage.getItem("highScore")}`;
    }
...
function update() {
    ...
    livesPara.textContent = `Lives: ${lives}`;
    ...
    setTimeout(update, 33.3333333); // 1000ms/33.3333333ms = 30 FPS
}
